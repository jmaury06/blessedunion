...
export default function Home() {
  return (
    <div className="min-h-screen w-full flex flex-col bg-gradient-to-br from-purple-50 via-white to-pink-50">
      <main className="flex-1 flex flex-col items-center justify-center p-6 md:p-12 py-20">
        ...
        >
          ...
          <motion.p
            ...
            className="text-xl md:text-3xl font-semibold text-gray-700 mb-8"
          >
            🎉 Rifa de Boda
          </motion.p>
          ...
          <motion.div
            ...
            animate={{ opacity: 1, y: 0 }}
            transition={{ delay: 0.8 }}
            className="bg-white rounded-3xl shadow-2xl p-8 md:p-12 mb-12 border border-gray-200 w-full"
          >
            {/* Fecha y Lotería */}
            <div className="mb-10 p-6 bg-gradient-to-r from-yellow-50 to-orange-50 rounded-2xl border-2 border-yellow-300">
              <div className="text-4xl mb-3">📅</div>
              <h3 className="font-bold text-gray-800 mb-2 text-2xl">Sorteo</h3>
            ...
            <div className="mb-12 p-6 bg-gradient-to-r from-red-50 to-pink-50 rounded-2xl border-2 border-red-300">
              <div className="text-4xl mb-3">⚠️</div>
              <h3 className="font-bold text-gray-800 mb-2 text-xl">Importante</h3>
            ...
            <p className="text-lg md:text-xl text-gray-700 mb-12 leading-relaxed text-center max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8 md:gap-10">
              <motion.div
                ...
                className="p-8 bg-gradient-to-br from-purple-50 to-pink-50 rounded-2xl border-2 border-purple-200 text-center"
              >
                <div className="text-5xl mb-4">🎫</div>
                <h3 className="font-bold text-gray-800 mb-2 text-xl">1000 Números</h3>
                <p className="text-gray-600 text-base">Del 000 al 999</p>
              </motion.div>
              ...
              <motion.div
                ...
                className="p-8 bg-gradient-to-br from-blue-50 to-cyan-50 rounded-2xl border-2 border-blue-200 text-center"
              >
                <div className="text-5xl mb-4">⏱️</div>
                <h3 className="font-bold text-gray-800 mb-2 text-xl">Links Seguros</h3>
                <p className="text-gray-600 text-base">Expiran en 30 minutos</p>
              </motion.div>
              ...
              >
                <div className="text-5xl mb-4">✅</div>
                <h3 className="font-bold text-gray-800 mb-2 text-xl">Sin Duplicados</h3>
                <p className="text-gray-600 text-base">Cada número es único</p>
              </motion.div>
            </div>
          </motion.div>
          ...
          >
            ...
            <a href="https://github.com/jmaury06/blessedunion" target="_blank" rel="noopener noreferrer">
              <motion.button
                whileHover={{ scale: 1.05, y: -2 }}
                whileTap={{ scale: 0.95 }}
                className="bg-white text-gray-800 px-10 py-4 rounded-2xl font-bold text-lg shadow-2xl hover:shadow-xl transition-all duration-300 border-2 border-gray-300"
              >
                <span className="flex items-center gap-2">
                  📖 Documentación
                </span>
          ...
          <motion.p
            ...
            className="mt-10 text-gray-600 text-center max-w-2xl mx-auto"
          >
      ...
      {/* Footer - Sticky */}
      <footer className="py-6 text-center bg-white/70 backdrop-blur-sm border-t border-gray-200 mt-auto">
